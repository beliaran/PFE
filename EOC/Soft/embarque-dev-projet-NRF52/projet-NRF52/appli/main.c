...
#include "objects/molkky.h"
#include "objects/molkky_pin.h"
#include "objects/molkky_basket.h"
...
//    	BUTTONS_process_main();
    	...
    	//Orientation du main vers chaque code de chaque objets
			...
			OBJECT_VENTILATOR_etat_updated_callback();
    			...
    			molkky_mpu_state_machine();
    		#endif

			#if OBJECT_ID == MOLKKY_ESB_TX
    			molkky_esb_tx_state_machine();
    		#endif

			#if OBJECT_ID == MOLKKY_ESB_RX
    			molkky_esb_rx_state_machine();
    		#endif

			#if OBJECT_ID == MOLKKY
    			molkky_pin_state_machine();
			#endif

			#if OBJECT_ID == MOLKKY_BASKET
    			molkky_basket_state_machine();
    		#endif

			#if OBJECT_ID == MOLKKY_PIN_BOARD
    			molkky_pin_board_state_machine();
			#endif
...
char * object_id_to_string(uint8_t id)
{
	...
	switch(id)
	{
		...
		case MOLKKY_PIN:				ret = "Molkky_pin";			break;
		case MOLKKY_BLINKY:				ret = "Molkky_blinky";		break;
		case MOLKKY_ESB_TX:				ret = "Molkky_esb_tx";		break;
		case MOLKKY_ESB_RX:				ret = "Molkky_esb_rx";		break;
		case MOLKKY_MPU:				ret = "Molkky_mpu";			break;
		default:
			break;
	}
	return ret;
